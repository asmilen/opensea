    ...
    <div class="modal-dialog" role="document" style="width: 95%; max-height: 570px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Update tour request</h4>
            </div>
            <div class="modal-body" style="overflow-y: auto; max-height: calc(100vh - 205px);">
                <div class="form-group col-sm-6">
                    <label for="" class="col-sm-2 control-label">Name<span style="color: red">*</span></label>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" ng-model="editArticle.contact" disabled>
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    <label for="" class="col-sm-2 control-label">Tour</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" rows="4" ng-model="editArticle.tour_name" disabled>
                    </div>
                </div>
                <div class="form-group col-sm-6">
                    <label for="" class="col-sm-2 control-label">Nation</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" ng-model="editArticle.nation" disabled>
                    </div>
                </div>
                <div class="form-group col-sm-6">
                ...
                <div class="form-group col-sm-6">
                    <label for="" class="col-sm-2 control-label">Special request</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="4" ng-model="editArticle.special_request" disabled></textarea>
                    </div>
                </div>
                <div class="form-group col-sm-6">
                ...
                <div class="form-group col-sm-6">
                    <label for="" class="col-sm-2 control-label">Number people</label>
                    <div class="col-sm-10">
