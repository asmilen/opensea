...
window.footerContent = {
  en: {
    ...
    addressH1: 'OPENSEA TOURISM AND SERVICES COMPANY',
...
window.bonbonContent = {
  en: {
    ...
    highlight3: {
      ...
      h2: 'Available in 3 languages on all tours',
      content: 'Language included: English, Vietnamese, Chinese. All BonBon bus offers audio guide in English, Vietnamese and Chinese which will give you information on every stop as well as activities along the way. We will also provide you our very own brochure to the essential sights, sounds and tastes from east to west that define Hanoi.'
    },
    highlight4: {
      h1: 'DEPARTURE POINTS',
    ...
    route: {
      h1: `BONBON ROUTE`,
      h2: `Bon this way`,
      text: `Buses arrive at each stop every 30 minutes, so you can quickly rejoin the tour whenever you like. Our bus route has been carefully planned to ensure that you'll capture all the best sights of Hanoi including Hanoi Opera House, Long Bien Bridge, Van Mieu, Imperial Citadel of Thang Long and more`,
  ...
  vi: {
    ...
    highlight3: {
      ...
      h2: 'Cung cấp thông tin du lịch đầy đủ bằng 3 thứ tiếng',
      content: '3 ngôn ngữ chúng tôi hỗ trợ bao gồm: tiếng Anh, tiếng Việt, tiếng Trung. Tất cả xe BonBon đều có hướng dẫn du lịch bằng âm thanh cung cấp cho bạn thông tin về mọi điểm dừng cũng như các địa điểm thú vị trên đường đi. Chúng tôi cũng sẽ cung cấp tờ rơi du lịch về các điểm tham quan, nhà hàng và quán cà phê không thể bỏ qua ở Hà Nội.'
    },
    highlight4: {
      h1: 'Nhiều điểm dừng',
